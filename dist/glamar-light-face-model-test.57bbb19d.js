import * as __parcelExternal0 from "@mediapipe/tasks-vision";
...
})({"8vi4r":[function(require,module,exports,__globalThis) {
var HMR_HOST = null;
var HMR_PORT = 43525;
var HMR_SERVER_PORT = 43525;
var HMR_SECURE = false;
var HMR_ENV_HASH = "63cda9649d2dbc31";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "f87318c457bbb19d";
"use strict";
...
},{}],"3zMyA":[function(require,module,exports,__globalThis) {
...
const drawingUtils = new (0, _tasksVision.DrawingUtils)(overlayCtx);
...
async function loadModels() {
    try {
        ...
        if (!shardResp.ok) throw new Error(`Failed to fetch model shard: ${shardResp.status} ${shardResp.statusText}`);
...
function inferLight() {
    const input = tf.tidy(()=>{
        ...
        img = tf.image.resizeBilinear(img.expandDims(0), [
            LIGHT_INPUT,
            LIGHT_INPUT
        ]);
        return img;
    ...
    if (conf >= CONFIDENCE_THRESHOLD && best === lastClass) streak++;
...
// ── Drawing ──────────────────────────────────────────────────────────
const FACE_CONNECTIONS = (0, _tasksVision.FaceLandmarker).FACE_LANDMARKS_TESSELATION;
const FACE_CONTOURS = (0, _tasksVision.FaceLandmarker).FACE_LANDMARKS_FACE_OVAL;
const FACE_IRISES = (0, _tasksVision.FaceLandmarker).FACE_LANDMARKS_LEFT_IRIS.concat((0, _tasksVision.FaceLandmarker).FACE_LANDMARKS_RIGHT_IRIS);
...
function renderBars(probs) {
    resultsEl.innerHTML = probs.map((p, i)=>{
...
function webcamLoop() {
    var _cachedFaceResult_faceLandmarks;
    ...
    var _cachedFaceResult_faceLandmarks_length;
    const numFaces = (_cachedFaceResult_faceLandmarks_length = cachedFaceResult === null || cachedFaceResult === void 0 ? void 0 : (_cachedFaceResult_faceLandmarks = cachedFaceResult.faceLandmarks) === null || _cachedFaceResult_faceLandmarks === void 0 ? void 0 : _cachedFaceResult_faceLandmarks.length) !== null && _cachedFaceResult_faceLandmarks_length !== void 0 ? _cachedFaceResult_faceLandmarks_length : 0;
...
},{"@mediapipe/tasks-vision":"@mediapipe/tasks-vision"}]},["8vi4r","3zMyA"], "3zMyA", "parcelRequireedb7", {"@mediapipe/tasks-vision": __parcelExternal0,})
let {} = parcelRequireedb7("3zMyA");
export {};

//# sourceMappingURL=glamar-light-face-model-test.57bbb19d.js.map
